...
export default defineConfig({
  ...
  // a GitHub Pages project site at `/<repo>/`, a CDN behind a subpath
  // proxy, etc. The `zarrcade-build` CLI may override this via the
  // ZARRCADE_BASE env var when an absolute base is required (e.g. an SPA
  // that ever needs absolute asset URLs); otherwise this default is
